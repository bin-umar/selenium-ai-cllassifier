...
import { imageFromScreenshot, getCanvasByRect, canvasFromImageData, canvasFromImage,
...
async function getElementImages (els, screenshotImg) {
...
function getConfidenceThreshold (driver) {
...
async function findViaElementScreenshots (driver, label, allowWeakerMatches) {
...
async function find (driver, label, /* multiple */) {
